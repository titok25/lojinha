   ...
   <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3  bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
	  ...
	  <li class="nav-item">
		...
		<li class="nav-item">
          <a class="nav-link active text-white bg-gradient-primary" href="apis.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
...
<button type="button" class="btn bg-gradient-info" data-bs-toggle="modal" data-bs-target="#exampleModal0">
  Texto para whatsapp.
</button>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title font-weight-normal" id="exampleModalLabel">Texto enviado ao cliente via whatsapp.</h5>
        <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
	  <div class="modal-header">
         <h6 class="modal-title font-weight-normal" id="exampleModalLabel">$nome, $idCliente etc.. significa os dados do cliente</h6>
      </div>
	  <div class="modal-header">
         <h6 class="modal-title font-weight-normal" id="exampleModalLabel">\r significa quebra de linha</h6>
      </div>
      <div class="modal-body">
      
	     <textarea class="multisteps-form__textarea form-control" rows="11" spellcheck="false" id="textoszap"></textarea>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn bg-gradient-secondary" data-bs-dismiss="modal">Fechar</button>
        <button type="button" class="btn bg-gradient-success" onclick="salvarZAP()">Salvar</button>
      </div>
    </div>
  </div>
</div>
	...
	<!--MODAL-->
	<!-- Button trigger modal -->
<button type="button" class="btn bg-gradient-info" data-bs-toggle="modal" data-bs-target="#exampleModal2">
  Engenharia html para e-mail.
</button>
...
<div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title font-weight-normal" id="exampleModalLabel">Configurar dados de envio ao cliente.</h5>
        <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
	  <div class="modal-header">
         <h6 class="modal-title font-weight-normal" id="exampleModalLabel">$nome, $idCliente, $valores, $bairro, $numero, $cidadeXestado, $cep, <b>significa dados do cliente</b>.</h6>
      </div>
	  
      <div class="modal-body">
	  <h5 class="modal-title font-weight-normal" id="exampleModalLabel">Texto</h5>
       <textarea class="multisteps-form__textarea form-control" rows="5" spellcheck="false" id="texto1"></textarea>
	  </div>
	  
	  <div class="modal-body">
	  <h5 class="modal-title font-weight-normal" id="exampleModalLabel">Código html</h5>
       <textarea class="multisteps-form__textarea form-control" rows="5" spellcheck="false" id="textoshtml"></textarea>
	  </div>
      <div class="modal-footer">
        <button type="button" class="btn bg-gradient-secondary" data-bs-dismiss="modal">Fechar</button>
        <button type="button" class="btn bg-gradient-success" onclick="salvarHTML()">Salvar</button>
      </div>
    </div>
  </div>
</div>
