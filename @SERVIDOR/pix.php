...
<script>
  ...
  function atualizar(){
	 ...
	 // codigo abaixo comentado, por causa da lara assas do cliente
	 /*
	  ...
	  */
	 //############## foi adicionado para que lara assas do cliente, não bugue!
	  $.post("api_adm/", {painel:"trocapix", chave:cha, cidade:city, identificador:iden, beneficiario:bene, descricao:des},function(zeragem){
