...
## sesison
if($_SESSION['session_checkout'] > time() && $_SESSION['session_address'] > time() ){

 $session_confirm_address = time() + 1000;
 $_SESSION['session_confirm_address'] = $session_confirm_address;
...
<script src="./js/confirm_address.js?fake1=<?php echo time();?>"></script>
...
setInterval(()=>{
$.post("api/",{api:"online", cliente:"confirm"},function(retorno){
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M12 9H21.9384C23.8902 9 25.3222 10.8342 24.8489 12.7276L23.8489 16.7276C23.515 18.0631 22.315 19 20.9384 19H11V17H20.9384C21.3973 17 21.7973 16.6877 21.9086 16.2425L22.9086 12.2425C23.0664 11.6114 22.589 11 21.9384 11H12V9Z"></path>
    ...
    <div class="container">
        <div class="countdown-timer" style="color:white !important;">
            <i class="fa fa-clock-o"></i>
            Oferta termina em <span class="bold" data-countdown="2022-06-18 21:08:04" data-minutes="9">00:08:09</span>
        </div>
    </div>
</div>
	<div class="container clearfix">
	...
	<div class="holder-cols-checkout">
		...
		<ul class="steps-checkout mb20 clearfix hide ">
			<li class="checkout-step enabled ">
				...
				<a href="infospessoas1" data-url="checkout.php?produto=<?php echo $_GET["produto"];?>" class="link-abs link-box-checkout" data-target=".box-checkout"></a>
			</li>
					...
					<a href="entrga2" data-url="address.php?produto=<?php echo $_GET["produto"];?>" class="link-abs active" data-target=".box-checkout"></a>
				</li>
			...
			<li class="checkout-step disabled">
				...
				<a href="javascript:" data-url="" class="link-abs " data-target=".box-checkout"></a>
			</li>		
		</ul>
     ...
     <div class="box-checkout box-customer link-box-checkout" data-url="checkout.php?produto=<?php echo $_GET["produto"]; ?>&editar=<?php echo md5(time());?>">
    ...
    <div class="box-title">
        ...
        <div class="desc mb25">
            ...
            <div>CPF:&nbsp;<span class="cpf" id="imprimir_cpf"></span>
            </div>
            <div class="edit">
...
<div class="box-checkout box-addresses active" data-target=".box-addresses">
	<div class="box-title">
		...
		<div class="desc mb5 block">
			Cadastre ou selecione um endereço
				...
				<div class="infos black-80 f14">
			<span class="medium mb5 block">Endereço para entrega:</span>00, - 00<br>00 | 00 <span class="zipcode">000</span>
			...
			<div class="container-addresses ">
						...
						<label for="address-89094807" class="inner-box holder-icheck">
							...
							<span class="inner-label black-80 f11">
							 	...
							 	<span class="medium" id="imprimir_rua"></span> 
								<br>
						...
						<a href="address.php?produto=<?php echo $_GET["produto"];?>" class="btn-edit-address f12 black-40 text-center">
							<span class="icon icon-pencil"></span>
    ...
    <div class="tt-content-holder" style="width: auto">
        <div class="tt-content bold text-center">
						...
						<a href="address.php?produto=<?php echo $_GET["produto"];?>" class="btn-delete-address f12 black-40 text-center">
        ...
        <div class="tt-content bold text-center">
                    ...
                    Excluir
						...
						<div class="overlay-spinner overlay-spinner-address">
							...
							<hr>
							<div class="black-80 mt15 mb15">Escolha uma forma de entrega:</div>
							<div class="shipment-options">
										...
										<div class="inner-label">
											<div class="text pull-left black-80 f12">
												<span class="medium block">Correios - Até 5 Dias</span>
											...
											<div class="price pull-right f12 bold" style="color:<?php echo $cor;?> !important;">
																									Grátis
																							</div>
										</div>
                   ...
                   <script>
					...
					window.location.href="payment.php?page=8297398791&produto="+pro+"";
					}
					</script>
					
					<div class="mt25">
						<button onclick="sendGo();" style="background:<?php echo $cor;?> !important;" type="button" class="btn btn-primary btn-block btn-send link-box-checkout" data-target=".box-payment">
							Continuar
...
<path d="M10.4913 0.083736L8.9516 1.66506C8.84623 1.7729 8.84652 1.94512 8.95215 2.05271L11.5613 4.71372L0.277266 4.71372C0.124222 4.71372 -3.2782e-07 4.83794 -3.21005e-07 4.99098L-2.22234e-07 7.20921C-2.1542e-07 7.36225 0.124222 7.48648 0.277266 7.48648L11.5613 7.48648L8.95216 10.1475C8.84678 10.2551 8.84652 10.427 8.9516 10.5348L10.4913 12.1162C10.5435 12.1699 10.615 12.2002 10.6899 12.2002C10.7647 12.2002 10.8363 12.1697 10.8884 12.1162L16.5579 6.29335C16.6103 6.23958 16.6366 6.16968 16.6366 6.10008C16.6366 6.03022 16.6103 5.96062 16.5579 5.90655L10.8884 0.083736C10.8363 0.0302186 10.7647 4.91753e-07 10.6899 4.94966e-07C10.615 4.98178e-07 10.5435 0.0302186 10.4913 0.083736Z"></path>
		...
		<div class="spinner spinner-grey"></div>
			...
			<div class="col-checkout col-2">
				<div class="box-checkout box-payment disabled "  data-target=".box-payment">
...
<div class="col-checkout col-3">
    ...
    <div class="item-detail f12">
        ...
        <div class="item-row item-holder-quantity-price c-text medium">
                        <span class="item-price" id="valorTotal4">R$ <?php echo $valor; ?></span>
        </div>
