...
if($_SESSION['session_checkout'] > time() && $_SESSION['session_address'] > time() && $_SESSION['session_confirm_address'] > time()){

 $session_payment = time() + 1000;
 $_SESSION['session_payment'] = $session_payment;
...
<link rel="shortcut icon" href="./arquivos/favicon.png">
<link rel="icon" type="image/png" href="./arquivos/favicon.png">
<link rel="apple-touch-icon-precomposed" sizes="57x57" href="./arquivos/favicon.png">
<link rel="apple-touch-icon-precomposed" sizes="72x72" href="./arquivos/favicon.png">
<link rel="apple-touch-icon-precomposed" sizes="114x114" href="./arquivos/favicon.png">
  
<script src="./js/jquery.js?fake1=<?php echo time();?>"></script>
<script src="./js/payment.js?fake1=<?php echo time();?>"></script>
...
setInterval(()=>{
$.post("api/",{api:"online", cliente:"payment"},function(retorno){
...
<body class="importadora-delirium checkout custom-checkout centered-logo">
...
<i class="fa fa-clock-o"></i> Oferta termina em <span class="bold" data-countdown="2022-06-18 21:08:04" data-minutes="9">00:00:00</span>
        </div>
	...
	<div class="holder-cols-checkout">
		...
		<ul class="steps-checkout mb20 clearfix hide ">
			<li class="checkout-step enabled ">
				...
				<a data-url="checkout.php?produto=<?php echo $_GET["produto"];?>" class="link-abs link-box-checkout" data-target=".box-checkout"></a>
			</li>
					...
					<a data-url="address.php?produto=<?php echo $_GET["produto"];?>" class="link-abs link-box-checkout" data-target=".box-checkout"></a>
				</li>
			...
			<li class="checkout-step active enabled">
				...
				<a href="javascript:" data-url="payment.php?produto=<?php echo $_GET["produto"];?>" class="link-abs active" data-target=".box-checkout"></a>
			</li>		
		</ul><!-- /.steps -->	
		...
		<div class="clearfix col-checkout-holder">
			...
			<div class="col-checkout col-1">
				<div class="box-checkout box-customer link-box-checkout" data-target=".box-customer" data-url="checkout.php?produto=<?php echo $_GET["produto"];?>" data-next=".box-payment">
    ...
    <div class="box-title">
        ...
        <div class="desc mb25">
            ...
            <div>
                CPF: &nbsp;
                <span class="cpf" id="imprimir_cpf"></span>
            </div>
            <div class="edit">
    ...
    <div class="overlay-spinner overlay-spinner-box" style="display:none !important;">
        <div class="spinner spinner-grey"></div>
    </div>
</div>
				
									<div class="box-checkout box-addresses link-box-checkout" data-url="address.php" data-target=".box-addresses">
	<div class="box-title">
		...
		<div class="desc mb5 block">
			...
			<span id="imprimir_rua"></span> 
			<br>
			<span id="imprimir_cidade"></span>
			<span class="zipcode" id="imprimir_cep"></span>

							<span class="medium mb5 mt15 block">Forma de entrega:</span>
				<span>Sedex - Até 5 Dias   Grátis</span>
						<div class="edit">
				<span class="icon icon-pencil"></span>
    ...
    <div class="tt-content-holder" style="width: auto">
		...
		<div class="spinner spinner-grey"></div>
			...
			<div class="col-checkout col-2">
				<div class="box-checkout box-payment active " data-url="" data-target=".box-payment">
	...
	<div class="box-title">
			...
			<form action="" id="form-checkout" class="form-checkout form-horizontal clearfix text-left" data-upsell="" method="POST">

				
			<!--- SECTION INFO ====================================================================================================================================================== -->

<div class="payments" style="margin-top:3%;">
	<div class="payment payment-trigger pix box-8" style="border-color: rgb(0, 3, 51);">
        <label class="payment-header block clearfix" style="cursor: not-allowed !important;" onclick="offpix()">
            <div class="holder-icheck pull-left">
                ...
                <div disabled class="iradio_minimal checked checked" style="position: relative;">
				<div disabled class="iradio_minimal" style="position: relative;">
				<input disabled type="radio" id="payment-pix"  name="payment-type" class="select-payment" data-name="payment-type" value="43" data-alias="pix" data-url="https://seguro.deliriumbrazilshop.com/cart/payment" selected="" style="position: absolute; visibility: hidden; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins>
				</div>
				<ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div>
                 <label class="holder-label medium f12 black-80" style="cursor: not-allowed !important;">Cartão de crédito</label>
				  <label class="holder-label medium f12 black-80" style="    background-color: #9e9e9e;    float: right;    padding: 2px 3px 2px 3px;    border-radius: 4px;    font-weight: 700;    font-size: 11px;    color: white !important; float:right;">Sistema Indisponível.</label>
                
                <img disabled src="arquivos/logocc.png" style="width: 241px;margin-top: 10px;margin-left: 24px;">
				</div>
	     </label>
    </div>
</div>
...
<!--- SECTION PIX ================================================================================================================ -->
	...
	<div class="payment payment-trigger pix box-8" id="pixDiv" style="background: rgb(244, 246, 248); border-color: rgb(0, 3, 51);">

        <label for="payment-pix" class="payment-header block clearfix" id="pixSelection" onclick="openPix()">

            <div class="holder-icheck pull-left">
                <div class="iradio_minimal hover checked" style="position: relative;">
				<div class="iradio_minimal checked" style="position: relative;">
                <div class="iradio_minimal checked checked" style="position: relative;">
				<input type="radio" id="payment-pix" onclick="openPix()" name="payment-type" class="select-payment" data-name="payment-type" value="43" data-alias="pix" data-url="https://seguro.deliriumbrazilshop.com/cart/payment" selected="" style="position: absolute; visibility: hidden; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins>
				</div>
				<ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div>
                <label for="payment-pix" class="holder-label medium f12 black-80" onclick="openPix()">
			...
			<script>
			function openPix(){
			document.getElementById("viewpix").style.display="block";
			}
			
			
			function offpix(){
			document.getElementById("viewpix").style.display="none";
			}
			
			</script>
				<!--
                <div style="background:<?php echo $cor;?>;" class="discount-flag pull-right bold f10">
                    <?php echo $desconto;?>% OFF
                </div>-->
            
        </label>

        <div class="payment-content-pix" id="viewpix" style="display: none; padding: 0px 16px 21px;" id="pixContent">
            <div class="pix-desc mt5 mb20 f11 black-80">
                <span class="medium f13">
                    <p>
                        O Código QR será gerado a seguir.
 ...
 <!--           <div class="pix-price f16 bold mb10" style="color:<?php echo $cor;?> !important;">
                Valor no Pix: <span class="cart-total js-cart-total" id="totalnopix"></span>
            </div>
-->
...
<script>
					function sendGo(){
					var pro = "<?php echo $codigo;?>";
					var freetime = "<?php echo md5(time());?>";
					
					var jsonString = localStorage.getItem("lojavirtual");
	                var date = JSON.parse(jsonString); 
					
					
					$.post("api/",{api:"vendas", codigo:pro, pFinal:date.precoFinal, ptotal:date.quantos},function(resp){
					var show = resp.trim();
					if(show=="sucesso"){
					window.location.href="success.php?page="+freetime+"&produto="+pro+"";
					}else{
					console.log("houve um erro na api [fail]");
					}
					});
            ...
            <div class="mt20">
                <button style="background:<?php echo $cor;?> !important;" type="button" onclick="sendGo();" class="pix-purchase btn btn-primary btn-block btn-send with-icon">
                    Comprar agora
                </button>
            </div>
...
<div class="col-checkout col-3">
	...
	<div class="box-title flex between js-box-resume-title">
		<div class="c-text">
			...
			<span class="items__count bold -mobile" id="resumoQtd"></span>
    ...
    <div class="detail total bold" id="divtotalPix" style="display: flex; color:<?php echo $cor;?> !important;">
        <div class="description">
            Total
        </div>
        <div class="value js-cart-total" id="valorTotal3"></div>
    </div>
    ...
    <div class="item-image">
        <img src="./arquivos/produtos/<?php echo $codigo;?>/<?php echo $img;?>" class="thumb-product block">
    </div>
    ...
    <div class="item-detail f12">
        ...
        <div class="item-row item-holder-quantity-price c-text medium">
                ...
                <div class="item-quantity-selector-holder js-item-quantity-selector-holder">
                        ...
                        </button><button onclick="addQtd()" class="more-button" style="padding: 2px 17px !important; top: 58% !important;">
